...
class PoseCNN(Network):
    def setup(self):
        ...
        # and pool1 4x4x1024
        # To concat_out 4x4x2048
        # ======================Concatenate=======================
        (self.feed('pool1', 
                   'aux1_branch', 
                   'aux2_branch')
             .concat(3, name='concat_out_to_conv')
             .conv(1, 1, 1024, 1, 1, name='small_incep_1'))
        (self.feed('concat_out_to_conv')
             .conv(3, 3, 1024, 1, 1, name='small_incep_2'))
        (self.feed('small_incep_1', 
                   'small_incep_2')
             .concat(3, name='concat_out_1')
             .conv(1, 1, 1024, 1, 1, name='small_incep_3'))
        (self.feed('concat_out_1')
             .conv(3, 3, 1024, 1, 1, name='small_incep_4'))
        (self.feed('small_incep_3', 
                   'small_incep_4')
             .concat(3, name='concat_out_2')
             .conv(3, 3, 1024, 1, 1, name='small_incep_5'))
        (self.feed('concat_out_2')
             .conv(1, 1, 1024, 1, 1, name='small_incep_6'))
        (self.feed('small_incep_5', 
                   'small_incep_6')
