# ====================CLASS GoogLeNet========================
# This part of network structure is adapted from the GoogLeNet, 
# where all the average pooling layeys and fully connected layers 
# in original network that are used to produce classifier output 
# has been removed.
#
# Three intermediate outputs are generated at: 
# "1st Auxiliary Brach output"
# "2nd Auxiliary Brach output"
# "Main branch output"
#
# Note that all parameters in this part of network are pre-trained
# and fixed during the training
# =============================================================
...
class GoogLeNet(Network):
    def setup(self):
        # ======================Input Layer=======================
        # From Input Layer 224x224x3
        # To Inception 4a (output) 14x14x512
        # ======================Input Layer=======================
        (self.feed('data')
        ...
        (self.feed('icp3_out0', 
             ...
             .avg_pool(5, 5, 3, 3, padding='VALID', name='aux1_pool')
             .conv(1, 1, 128, 1, 1, name='aux1_branch'))
        # ================1st Auxiliary Brach Output===================
        # From Inception 4b (Input) 14x14x512
        # To Inception 4d (output) 14x14x528
        # ================1st Auxiliary Brach Output===================
        (self.feed('icp3_out')
        ...
        (self.feed('icp6_out0', 
             ...
             .avg_pool(5, 5, 3, 3, padding='VALID', name='aux2_pool')
             .conv(1, 1, 128, 1, 1, name='aux2_branch'))
        # =================2nd Auxiliary Brach Output================
        # From Input Layer 224x224x3
        # To Inception 4a (output)
        # =================2nd Auxiliary Brach Output================
        (self.feed('icp6_out')
        ...
        (self.feed('icp9_out0', 
                   ...
                   'icp9_out2', 
                   'icp9_out3')
             .concat(3, name='main_branch'))
        # ====================Main Brach Output=========================
        # Main Brach Output 7x7x1024
        # ====================Main Brach Output=========================
